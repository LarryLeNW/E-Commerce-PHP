...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 17, 2024 lúc 06:26 AM
...
(10, '6', 5, 'eqweqw', '2024-07-01 18:15:40'),
(10, '6', 5, 'eqweqwe', '2024-07-01 18:15:43');
...
(191, 6, '2024-07-01 18:15:20', 'lkfslkdjflk', '23482983128', 'sdjfklsdflkjlk', 'Trực tiếp khi nhận h', 24340000, '', '1');
...
INSERT INTO `loaisanpham` (`MaLSP`, `tenloaihang`, `nhasx`, `HinhAnh`, `Mota`) VALUES
...
INSERT INTO `sanpham` (`MaSP`, `MaLSP`, `TenSP`, `donvido`, `dongia`, `soluongton`, `SoLuong`, `HinhAnh`, `MaKM`, `ManHinh`, `HDH`, `CamSau`, `CamTruoc`, `CPU`, `Ram`, `Rom`, `SDCard`, `Pin`, `SoSao`, `SoDanhGia`, `TrangThai`) VALUES
...
(10, 14, 'Xiaomi Mi 8', '', 12990000, '', 10, 'img/products/xiaomi-mi-8-1-600x600.jpg', 1, 'IPS LCD, 6.26\', Full HD+', 'Android 8.1 (Oreo)', '12 MP và 5 MP (2 camera)', '24 MP', 'Qualcomm Snapdragon 660 8 nhân', '4 GB', '64 GB', 'MicroSD, hỗ trợ tối đa 512 GB', '3300 mAh, có sạc nhanh', 5, 2, b'11111111111'),
...
CREATE TABLE `tintuc` (
  ...
  `ngayduatin` varchar(50) NOT NULL,
...
--
ALTER TABLE `hoadon`
  MODIFY `MaHD` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=192;
